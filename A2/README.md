...
1. **Сборка и запуск кода на C++**
   - Компилируйте и запускайте код, чтобы сгенерировать результаты тестирования:
     - `results1.csv` для MergeSort.
     - `results2.csv` для гибридного MergeSort.

2. **Запуск Python-скрипта**
   - Убедитесь, что файлы `results1.csv` и `results2.csv` находятся в рабочей директории.
   - Запустите Python-скрипт для построения графиков:
     ```bash
     python visualize_results.py
     ```
   - Графики будут сохранены в текущей директории.
